...
def build_manifest() -> dict:
    ...
    return {
        ...
        "geometry_banner": "LA GEOMETRIA DI EVIDENZA F2 È IN SOLA LETTURA — F3 NON RILOCALIZZA E NON CORREGGE LE REGIONI",
...
<body><header><strong>CEW — Viewer della fonte primaria</strong><span id=\"task-label\"></span><div id=\"authority\"></div><div id=\"geometry\"></div></header><main><section><div id=\"viewer\"></div></section><aside><label>Task di risoluzione</label><select id=\"task-select\"></select><div><button id=\"fit\">Centra evidenza</button><button id=\"home\">Intera tavola</button></div><p><button id=\"original-mode\" aria-pressed=\"true\">Originale</button> <button id=\"enhanced-mode\" disabled>Migliorata — non disponibile</button></p><p><b>Indicazione:</b> la cornice rossa “ZONA DA CONTROLLARE” è la regione di evidenza F2 certificata per questo task.</p><dl id=\"details\"></dl></aside></main><script src=\"app.js\"></script></body></html>"""
