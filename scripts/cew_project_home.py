...
<section><h2>Percorso di valutazione</h2><p class="muted">Il percorso P0–P16 organizza il lavoro, ma non sostituisce i gate ingegneristici e non crea una falsa percentuale di completamento.</p>{''.join(lifecycle_groups)}</section>
