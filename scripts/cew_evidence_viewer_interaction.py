...
_READOUT_NEW = '</div><div class="viewer-readout"><span id="viewerState">Evidenza · Zoom 100% · Pan non usato · Rotazione 0°</span><span class="viewer-help">Trascina per spostarti · rotella/trackpad o +/− per zoom · 0 per reset</span></div><p id="scaleNote" class="muted">MICRO — regione di evidenza con piccolo margine di lettura.</p>'
