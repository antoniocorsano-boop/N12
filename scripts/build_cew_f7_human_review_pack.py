...
def main():
    ...
    acknowledgement=receipt_schema['authority_acknowledgement_exact']
    ...
    for tid in contract['reference_tasks']:
        ...
        entries.append({
            ...
            'authority_acknowledgement_exact':acknowledgement,
            'decision_template':{
                ...
                'target_id':'','reopen_approval_id':'','authority_acknowledgement':''
            }
        })
    manifest={'contract_id':contract['contract_id'],'receipt_schema_id':receipt_schema['schema_id'],'authority':'HUMAN_REVIEW_INPUT_ONLY','ui_language':'it','guided_review':True,'compact_review':True,'prefilled_decisions':0,'entries':entries}
