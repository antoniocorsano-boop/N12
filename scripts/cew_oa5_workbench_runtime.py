...
import cew_oag5_workbench_runtime as oag5_runtime
...
def augment(rendered: str, task: str) -> str:
    ...
    candidate is persisted append-only before it can reach explicit OA-G5 review.
    """
    if OA5_RUNTIME_MARKER in rendered:
        return oag5_runtime.augment(rendered, task)
