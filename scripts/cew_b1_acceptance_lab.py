...
def task_specs() -> list[dict]:
    ...
    return [
        {**row, "start_path": starts[row["task_id"]]}
        for row in metrics.get("initial_cew_b11_tasks", [])
    ]
